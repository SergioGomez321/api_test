...
import com.test.softtek.sgomez.controller.StudentController;
...
public class StudentControllerTest {
    ...
    @Test
    void getStudentsOk() {
        Response<List<Student>, String> response = this.studentController.getStudents();
    ...
    void createStudentOk(){
        ...
        Response<Student, String> response = this.studentController.createStudent(student);
        Assertions.assertNotNull(response);
        Assertions.assertNotNull(response.getData());
